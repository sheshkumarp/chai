...
$.fn.eventCalendar = function (e) 
{
    ...
    function a(e, t, a) 
    {
        ...
        if (l.showDayAsWeeks) {
            ...
            dt = new Date(t, a, 1);
            var y = dt.getDay();
            for (l.startWeekOnMonday && (y = dt.getDay() - 1), 0 > y && (y = 6), 
                // console.log("V: " + f + " M: " + y + " P: " + p), 
                f = y; f > 0; f--) h.push('<div class="day not-current"></div>')
        }
                    ...
                    if (e = $(e).sort(t), e.length) {
                        ...
                        $.each(e, function (e, t) {
                            ...
                            if (parseInt(m) <= 9 && (m = "0" + parseInt(m)), (0 === a || a > c) && !(s !== !1 && s != h || "" != r && r != f || "" != n && n != u)) {
                                ...
                                var contentHtml = '<li id="'+e+'" class="'+t.type+'">';
                                contentHtml += '<div class="course-sec-desc no-image">';
                                contentHtml += '<img width="35" alt="" src="'+C+'">'+_+'<div class="time-sec" datetime="'+o+'"> '+t.obj_time;
                                contentHtml += '</div>';
                                contentHtml += '<div class="price d-flex justify-content-between align-items-end">';
                                contentHtml += '<div class="cart-wrap d-flex align-items-center cart_'+t.obj_id+'" data-cart="cart_'+t.obj_id+'">';
                                contentHtml += '<span><img src="'+SITEURL+'/assets/web/images/cart-btn-wht.png" alt="Add to Cart Icons"/></span> ';
                                contentHtml += ''+g+'';
                                contentHtml += '</div>';
                                contentHtml += '</div>';
                                contentHtml += '</li>';
