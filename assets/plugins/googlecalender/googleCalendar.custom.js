    ...
    function a(e, t, a)
    {
        ...
        for (dayCount = 1; dayCount <= p; dayCount++) {
           ...
           // else {
            ...
            $current_class = '';
            if(currDate[2] == dayCount && currDate[1]==a+1)
            {
                $current_class = 'currentDate';
            }


            h.push('<div id="dayList_' + dayCount + '" rel="' + dayCount + '" class="eventsCalendar-day day ' + m + '  '+$current_class+'">' + w + "</div>")
                        ...
                        $.each(e, function (e, t) 
                        {
                           ...
                           // console.log(u + "/" + (h+1) + "/" + f)
                            ...
                            if(currDate[0]==u && currDate[1]==(h+1) && currDate[2]==f){
                               ...
                               // if(currDate[2] == f && currDate[1]==(h+1))
                               // {
