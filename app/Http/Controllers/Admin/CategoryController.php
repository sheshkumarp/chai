...
use App\Models\CategoryModel as BaseModel;
...
class CategoryController extends Controller
{
    ...
    public function __construct(BaseModel $BaseModel)
    {
        ...
        $this->ModuleView  = 'admin.categories';
        $this->ModulePath = 'admin.categories.';

        $this->middleware(['permission:manage-categories'], ['only' => ['edit','update','destroy','create','store']]);
    }
    ...
    public function getRecords(Request $request)
    {
        ...
        if (!empty($object) && sizeof($object) > 0) 
        {
            ...
            foreach ($object as $key => $row) 
            {
                ...
                $edit  = '<a  href="javascript:void(0)" onclick="return updateCategoryCollection(this)" data-href="'.route('admin.categories.update', [base64_encode(base64_encode($row->id))]) .'" data-title="'.$row->title.'" ><img src="'.url('/assets/admin/images').'/icons/edit.svg" alt=" edit"></a>';
               
                $delete = '<a href="javascript:void(0)" onclick="return deleteCategoryCollection(this)" data-href="'.route('admin.categories.destroy', [base64_encode(base64_encode($row->id))]) .'" ><img src="'.url('/assets/admin/images').'/icons/delete.svg" alt=" delete"></a>';
