<div id="updateCategory" class="modal fade note-model" role="dialog">
   <div class="modal-dialog w-100">
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title">Update Cateegory</h4>
         </div>
         <form id="categoriesFormUpdate" action="" data-toggle="validator" role="form">
