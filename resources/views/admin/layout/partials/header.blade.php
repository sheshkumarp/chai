                            ...
                            <ul class="dropdown-menu header-menu">
                                <li>
                                    <a 
                                        href="#" 
                                        data-toggle="modal" 
                                        data-target="#updateAdminPassword" 
                                        onclick="document.getElementById('updateAdminPassword').reset()" 
                                        class="pt-4">
                                            <span>
                                                <img src="{{ asset('assets/admin/images//icons/lock.svg') }}">
                                            </span>
                                        Change Password
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/logout') }}" class="pb-2"><span>
